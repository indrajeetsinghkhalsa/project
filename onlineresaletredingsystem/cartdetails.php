...
<!--slider down data-->            
         ...
         <font style=" font-size:18px;"> &nbsp; Your Cart Details</font>
		    ...
		    mysql_connect('localhost','indrajeetsingh','8605244154') or die("ERROR:Connection lost");
   mysql_select_db('indrajeetsingh');
	      ...
	      ?>
            ...
            <td width="75" align="center"><?php echo $i;?></td>
             ...
             <td width="75" align="center"><a href="cartdel.php?code2=<?php echo $row['ser_no'];?>" style="text-decoration:none;"><img src="image/icon_cart.png"></a></td>

            <td width="300" align="center"><img src="image/<?php echo $row['image1'];?>" height="80" width="110" style="border:0px solid #000000;" ></td>
...
$_SESSION['amt']=$amt;
      ...
      <td width="300" style="background-color:#FFFFFF;"></td>
       ...
       <td  width="200" align="center"><?php echo" <font color='#FF0000'> <b>Rs. </b></font>" .$amt;?></td>
            ...
            <div style="width:300px; height:50px; border:0px solid #000000; " ><a href="index.php"><img src="image/bt_continue_shopping.png"></a>&nbsp;&nbsp;&nbsp;
